...
| Профессия | Описание |
|:-----|:---------|
| **Аналитик данных**<br/>(Data scientist, ML engineer) | • Работает с корпоративными данными, анализирует их и разрабатывает решения на основе ИИ.<br>• Определяет подходящий ML‑метод и адаптирует его к задаче.<br>• Разрабатывает признаки (feature engineering).<br>• Строит полный конвейер обработки данных (pipeline).<br>• Ведёт техническую документацию. |
| **Менеджер в ИИ**<br/>(Manager in AI) | • Руководит проектом, контролирует сроки и ресурсы.<br>• Отвечает за внедрение ML‑решения в продуктивную среду.<br>• Участвует в подготовке документации и анализе обратной связи (feedback). |
| **Технический аналитик в ИИ**<br/>(Technical analyst in AI) | • Является связующим звеном между заказчиком и ML‑командой.<br>• Анализирует бизнес‑процессы и готовит техническое задание (ТЗ).<br>• Оценивает реализуемость решений и участвует в их тестировании. |
| **Инженер данных**<br/>(Data engineer) | • Сбор, очистка и передача данных внутри компании.<br>• Поддержка хранилищ данных и конвейеров (pipelines). |
