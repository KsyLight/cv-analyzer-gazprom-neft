...
#### Серкибаев Аким – @s_Akim_s – капитан
- Роль в проекте – ML ENGINEER
- Обработка данных, дообучение модели, разработка сервиса

#### Василенко Егор – @oknelisavroge
- Роль в проекте – ML ENGINEER
- Дообучение модели, разработка и докеризация сервиса, настройка сервера

#### Казённых Максим – @Madoka_wg
- Роль в проекте – DATA-ENGINEER
- Парсинг с GitHub, проектирование и создание базы данных

#### Нестерович Анна-Джейн – @anyucxx
- Роль в проекте – PRODUCT-MANAGER
- Бизнес-аналитика, вывод продукта на рынок

#### Лёвкина Екатерина – @klevkina
- Роль в проекте – DESIGNER
- Разработка дизайна для сервиса, UX/UI
...
- Теоретически полный MLOps‑контур: кеширование (уже есть), CI/CD, мониторинг и авто‑переобучение моделей (продумано на теоретической ML-схеме)

## ML-схема (реализована частисно, остальная часть теоретический вариант развития)
<div align="center">
  <img src="others/ML-ML_схема.png" alt="ML-схема" style="width:90%; max-width:1200px; height:auto;" />
</div>
