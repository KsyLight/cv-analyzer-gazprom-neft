...
if uploaded_file:
    ...
    try:
        ...
        # Создаем вкладки: Опрос, Профессии, Рекомендации, Резюме
        ...
        with tab2:
            ...
            with col2:
                # Считаем относительное и абсолютное соответствие
                percentages = []
                ...
                descriptions = {
                    'Аналитик данных (Data scientist, ML engineer)': (
                        'Специалист, который работает с данными компании, анализирует их и ' 
                        'разрабатывает решения на основе ИИ.'
                    ),
                    'Менеджер в ИИ (Manager in AI)':
                        'Руководит проектом, контролирует сроки и ресурсы, отвечает за внедрение решения.',
                    'Технический аналитик в ИИ (Technical analyst in AI)':
                        'Связывает заказчика и ML-команду, готовит ТЗ и участвует в тестировании.',
                    'Инженер данных (Data engineer)':
                        'Готовит данные: собирает, очищает, передаёт, поддерживает пайплайны.'
                }
                prof_name_mapping = {
